...
//     const newTransmission = { speed, acceleration, resistance, update_config: this.state.data.update_config, ups }

//     this.state.update(newTransmission, 'transmission_object', message => this.setState({ message }))
//   }
...
//     return (
//       <div className='Dashboard-Aprimorator-content-inside-body'>
//         <p className='Dashboard-Aprimorator-content-inside-body-partName'>Cãmbio +{this.state.data.ups}</p>
