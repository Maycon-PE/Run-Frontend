...
//     const brake = this.state.data.brake
//     const ups = this.state.data.ups + 1

//     const newWhells = { speed, acceleration, brake, update_config: this.state.data.update_config, ups }

//     this.state.update(newWhells, 'whells_object', message => this.setState({ message }))
//   }
...
//     return (
//       <div className='Dashboard-Aprimorator-content-inside-body'>
//         <p className='Dashboard-Aprimorator-content-inside-body-partName'>Rodas +{this.state.data.ups}</p>
